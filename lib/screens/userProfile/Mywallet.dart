...
class _MyWalletState extends State<MyWallet> {
  ...
  addAmountApi() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('https://hellostay.com/api/auth/add-wallet-amount'));
    request.fields.addAll({'amount': addAmountCtr.text});
          ...
          actions: <Widget>[
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ElevatedButton(
                ...
                child: const Text(
                  'Cancel',
                  style: TextStyle(color: AppColors.white, fontFamily: "rubic"),
                ),
              ),
              ElevatedButton(
                style: ElevatedButton.styleFrom(
